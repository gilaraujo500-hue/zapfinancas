...
# Credenciais do Z-API (adiciona no Railway em Variables)
Z_API_INSTANCE = os.environ.get('Z_API_INSTANCE', 'TEU_INSTANCE_ID')  # Ex: 3ADCB2F0...
Z_API_TOKEN = os.environ.get('Z_API_TOKEN', 'TEU_TOKEN')  # Ex: 68FB0810...
